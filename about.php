...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark text-light ">
     ...
     <ul class="navbar-nav me-auto mb-2 mb-lg-0">
       ...
       <center><h1 class="mb-5 mt-5">About Page</h1></center>

       <div class="container mb-5 mt-5">
       <h6>Myself $hruti Gujar from TY CSE (divB) build this site as interest in web related technologies.
        I have special interest to new learn things and thus I try to do my best at every stage of my life.
        </h6>
        </div>
